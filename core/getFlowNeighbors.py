...
def getFlowNeighborsContiguity(AREAS1, AREAS2, FlowValue, Level):
    """Build FlowLISA contiguity weights for OD flows.

    This is the Python 3/core-format counterpart of bobyellow/SpaceTimeFlowLISA
    contiguity/weightsFromFlows.py. Area ids in input flows are 1-based, while
    polygon neighbor dictionaries are 0-based.
    """
...
def STweightsFromFlows(AREAS1, AREAS2, FlowValue1, FlowValue2, Time1, Time2, Level):
    ...
    Supported levels match the original SpaceTime_weightsFlows.py:
    3/31/32/33/312 for contemporaneous, 49/491/492/494/413 for lagged,
    55 for hybrid, plus 1/18/19/10/108/109/2/12/120 for spatial FlowLISA
    compatibility.
    """
    grid1 = _area_rook_neighbors(AREAS1)
    grid2 = _area_rook_neighbors(AREAS2)
